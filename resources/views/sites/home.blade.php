...
@section('content')
<!-- start banner Area -->
			<section class="banner-area relativ " id="home" style="background: url('/img/bg1.jpg');" >
				<div class="overlay overlay-bg"></div>	
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							<h1 class="text-uppercase">
								Laboratorium Manajemen Lanjut Universitas Gunadarma		
							</h1>
							<p class="pt-10 pb-10">
								Bersama Kami Membangun Masa Depan
							</p>
			...
			<section class="feature-area">
				<div class="container">
					<div class="syarat">
						<h3 class="text-uppercase text-center" style="color: white;">
								Syarat Bergabung
								<hr>	
							</h3>
					</div>
					<div class="row">
							...
							<div class="single-feature">
								...
								<div class="desc-wrap" style="text-align: justify;">
									<ol>
									 ...
									 <li>Tidak terdaftar Sebagai Asisten atau Programmer Lab Lain,</li>
									 <li>IPK Minimal 2.90,</li>
									 <li>Mampu bekerjasama dan royal,</li>
									</ol>
						...
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>Terkonfigurasi Wifi yang Memadai</h4>
								</div>
								<div class="desc-wrap">
									<p>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Foto Laboratorium</h1>
						...
						<div class="active-popular-carusel">
							...
							<div class="single-popular-carusel">
								<div class="thumb-wrap relative">
									<div class="thumb relative">
										<div class="overlay overlay-bg"></div>	
										<img class="img-fluid" src="{{asset('/img')}}/bg3.jpg" alt="">
									</div>
							...
							<div class="single-popular-carusel">
								<div class="thumb-wrap relative">
									<div class="thumb relative">
										<div class="overlay overlay-bg"></div>	
										<img class="img-fluid" src="{{asset('/img')}}/bg7.1.jpg" alt="">
									</div>
							...
							<div class="single-popular-carusel">
								<div class="thumb-wrap relative">
									<div class="thumb relative">
										<div class="overlay overlay-bg"></div>	
										<img class="img-fluid" src="{{asset('/img')}}/bg8.1.jpg" alt="">
									</div>
